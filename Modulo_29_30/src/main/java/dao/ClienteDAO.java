...
public class ClienteDAO implements IClienteDAO {
    ...
    public Cliente buscar(String codigo) throws Exception {
        ...
        try {
            ...
            stm = connection.prepareStatement(sql);
            adicionarParametrosSelect(stm,Long.parseLong(codigo));
            rs = stm.executeQuery();
    ...
    private void adicionarParametrosSelect(PreparedStatement stm, Long codigo) throws SQLException {
    ...
    private String getSqlInsert() {
        StringBuilder sb = new StringBuilder();
        sb.append("INSERT INTO CLIENTE (CODIGO,CPF,NOME,ENDERECO,CIDADE,ESTADO,ID) ");
